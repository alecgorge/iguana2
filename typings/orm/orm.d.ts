...
declare module "orm" {
    ...
    module orm {
        ...
        export interface Model {
            ...
            hasOne(association_name: string, model: orm.Model, opts? : { reverse?: string; autoFetch?: boolean } ): void;
            hasMany(association_name: string, model: orm.Model, join_table_cols? : { [key: string]: Property }, opts? : { reverse?: string; autoFetch?: boolean } ): void;
